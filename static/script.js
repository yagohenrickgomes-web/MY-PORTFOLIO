...
const i18n = {
  pt: {
    ...
    service3_title:'Desenvolvimento Python', service3_desc:'Sistemas desktop e web sob medida, do banco de dados à interface final.',
    ...
    service6_title:'Soluções de Software', service6_desc:'Do diagnóstico à entrega: sistemas completos pensados para o seu processo.',
    ...
    exp1_date:'Atual', exp1_title:'Instituto + Visão', exp1_desc:'Desenvolvimento de soluções de automação e análise de dados para operações internas.',
    exp2_date:'Anterior', exp2_title:'CTR Contabilidade', exp2_desc:'Gestão de processos contábeis e implementação de rotinas automatizadas de conferência.',
    exp3_date:'Anterior', exp3_title:'Centro América Tecnologia', exp3_desc:'Desenvolvimento de sistemas e suporte técnico voltado a soluções de negócio.',
    ...
    edu3:'Ciências Contábeis — 6º semestre', edu4:'Pós-graduação em Licitações e Contratos — em andamento',
    cert_eyebrow:'Certificações', cert_title:'Aprendizado contínuo.', cert3:'Automação de Processos', cert4:'Inteligência Artificial Aplicada',
    gallery_eyebrow:'Galeria', gallery_title:'Dashboards e Business Intelligence.',
    gallery1:'Dashboard Financeiro', gallery2:'Painel de Contratos', gallery3:'Análise de Estoque', gallery4:'Relatório Power BI',
    ...
    blog_note:'Novos artigos em breve.',
  ...
  en: {
    ...
    service3_title:'Python Development', service3_desc:'Custom desktop and web systems, from the database to the final interface.',
    ...
    service6_title:'Software Solutions', service6_desc:'From diagnosis to delivery: complete systems designed for your process.',
    ...
    exp1_date:'Current', exp1_title:'Instituto + Visão', exp1_desc:'Development of automation and data analysis solutions for internal operations.',
    exp2_date:'Previous', exp2_title:'CTR Contabilidade', exp2_desc:'Accounting process management and implementation of automated review routines.',
    exp3_date:'Previous', exp3_title:'Centro América Tecnologia', exp3_desc:'System development and technical support focused on business solutions.',
    ...
    edu3:'Accounting Sciences — 6th semester', edu4:'Postgraduate in Public Tenders and Contracts — in progress',
    cert_eyebrow:'Certifications', cert_title:'Continuous learning.', cert3:'Process Automation', cert4:'Applied Artificial Intelligence',
    gallery_eyebrow:'Gallery', gallery_title:'Dashboards and Business Intelligence.',
    gallery1:'Financial Dashboard', gallery2:'Contracts Panel', gallery3:'Inventory Analysis', gallery4:'Power BI Report',
    ...
    blog_note:'New articles coming soon.',
